...
def expected_sarsa_control(s,a,r,s_prime, q_s_a, policy):
    q_s_a[s,a] = q_s_a[s,a] + ALPHA*(r + GAMMA*(q_s_a[s_prime]@policy[s_prime]) - q_s_a[s,a])
...
if __name__ == "__main__":
    ...
    for episode in tqdm(range(NUM_EPISODES)):
        ...
        while terminated == False:
            ...
            state_action_values, policy = expected_sarsa_control(
                s=observation,
                a=action,
                r=reward,
    ...
    save_object(agent, f"TD_ExpSARSA_ep_{NUM_EPISODES}_eps_{EPSILON}_gam_{GAMMA}_alph_{ALPHA}.pkl")