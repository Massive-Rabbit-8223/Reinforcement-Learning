...
def q_learning_control(s,a,r,s_prime, q_s_a, policy):
    q_s_a[s,a] = q_s_a[s,a] + ALPHA*(r + GAMMA*np.max(q_s_a[s_prime]) - q_s_a[s,a])
...
if __name__ == "__main__":
    ...
    for episode in tqdm(range(NUM_EPISODES)):
        ...
        while terminated == False:
            ...
            state_action_values, policy = q_learning_control(
                s=observation,
                a=action,
                r=reward,
    ...
    save_object(agent, f"TD_QLearning_ep_{NUM_EPISODES}_eps_{EPSILON}_gam_{GAMMA}_alph_{ALPHA}.pkl")