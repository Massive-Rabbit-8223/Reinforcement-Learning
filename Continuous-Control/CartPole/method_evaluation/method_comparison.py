...
for method in method_list:
    PATH_METRICS = ROOT_DIR + "/methods/"+method + "/training_statistics/metrics_dict_cpu.pkl"
...
plt.ylabel("Steps")
plt.legend()
plt.savefig(PATH+"/plots/"+"mean_traj_len.pdf")
plt.savefig(PATH+"/plots/"+"mean_traj_len.jpg")
plt.show()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig(PATH+"/plots/"+"epoch_loss.pdf")
plt.savefig(PATH+"/plots/"+"epoch_loss.jpg")
plt.show()