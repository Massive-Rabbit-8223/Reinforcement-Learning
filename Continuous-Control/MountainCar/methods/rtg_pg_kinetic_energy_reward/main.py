...
BATCH_SIZE = 1000
LEARNING_RATE = 1e-2
PATH_POLICY_MODEL = PATH + "/training_statistics/policy_model_wo_baseline_goal_reward_4.pth"
PATH_VALUE_MODEL = PATH + "/training_statistics/value_model_wo_baseline_goal_reward_4.pth"
PATH_METRICS = PATH + "/training_statistics/metrics_dict_wo_baseline_goal_reward_4.pkl"
ENV = "MountainCar-v0"
